...
// 从环境变量获取配置
const API_ENCRYPT_ENABLE = process.env.VUE_APP_API_ENCRYPT_ENABLE === 'true'
const API_ENCRYPT_HEADER = process.env.VUE_APP_API_ENCRYPT_HEADER || 'X-Api-Encrypt'
const API_ENCRYPT_ALGORITHM = process.env.VUE_APP_API_ENCRYPT_ALGORITHM || 'AES'
const API_ENCRYPT_REQUEST_KEY = process.env.VUE_APP_API_ENCRYPT_REQUEST_KEY || '' // AES密钥 或 RSA公钥
const API_ENCRYPT_RESPONSE_KEY = process.env.VUE_APP_API_ENCRYPT_RESPONSE_KEY || '' // AES密钥 或 RSA私钥
